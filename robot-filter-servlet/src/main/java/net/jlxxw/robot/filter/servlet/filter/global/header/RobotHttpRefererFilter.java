...
public class RobotHttpRefererFilter implements Filter {
    private static final Logger logger = LoggerFactory.getLogger(RobotHttpRefererFilter.class);
    @Autowired
    ...
    @Override public void doFilter(ServletRequest request, ServletResponse response,
        ...
        logUtils.debug(logger, "data arrival filter: RobotHttpRefererFilter");
        ...
        if (StringUtils.isNotBlank(referer)) {
            ...
            logUtils.warn(logger, "RobotHttpRefererFilter found a no origin request,ip:{}",ipAddress);
        }
