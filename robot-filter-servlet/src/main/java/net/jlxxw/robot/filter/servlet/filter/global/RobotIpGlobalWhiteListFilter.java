...
public class RobotIpGlobalWhiteListFilter extends AbstractFilterTemplate {
    ...
    protected void filter(ServletRequest request, ServletResponse response,
        ...
        try {
            Set<String> globalList = (Set<String>) cache.get("globalWhiteList", () -> robotFilterProperties.getGlobalIpWhitelist());
            if (globalList.contains(clientIp)){
               // set no check context todo
